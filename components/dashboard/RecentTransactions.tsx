    ...
    <div className="bg-white border border-[#E2E8F0] rounded-[12px] p-[18px] hover-card">
      ...
      <div className="space-y-1">
        {recent.map((t, i) => (
          ...
          >
            <span className="text-[16px] transition-transform duration-200 group-hover:scale-110">{categoryIcons[t.category || t.source || 'other']}</span>
            <div className="flex-1 min-w-0">
              <p className="text-[12px] font-medium text-[#111827] truncate group-hover:text-[#3B5BDB] transition-colors duration-200">{t.description || (t.type === 'income' ? 'Income' : 'Expense')}</p>
